            ...
            <nav class="bg-white border-gray-200 shadow">
                <div class="max-w-screen-xl flex flex-wrap items-center justify-between mx-auto p-4">
                    <a href="#" class="flex items-end space-x-3 rtl:space-x-reverse">
                        <span class="self-center text-2xl font-semibold whitespace-nowrap">Howdy, Admin</span>
                    </a>
                    <div class="flex items-center md:order-2 space-x-2 rtl:space-x-reverse justify-between">
                        ...
                        <div class="z-50 hidden my-10 text-base list-none bg-white divide-y divide-gray-100 rounded-lg shadow m-5" id="announcement-dropdown">
                            ...
                            <!-- <ul class="py-2" aria-labelledby="announcement-menu-button">
                                <li>
                                    <a href="#" class="block px-4 py-2 text-sm text-gray-700 hover:bg-gray-100">Annoucement</a>
                                </li>
                                <li>
                                    <a href="#" class="block px-4 py-2 text-sm text-gray-700 hover:bg-gray-100">Settings</a>
                                </li>
            ...
            <section>
                <div class="block md:grid grid-cols-1 md:grid-cols-9 gap-4 justify-between items-center mt-7 mx-5 md:mx-auto">
                    ...
                    <div class="col-span-5 items-end">
                        <div class="border-gray-200 shadow-md rounded-md bg-white mt-5 md:mt-0">
                            <div class="flex justify-between items-center mx-5">
                                <div class="p-3 py-4">Assign Parent</div>
                                
                            </div>
                            <div class="flex flex-row justify-center items-center my-10">
                                                            
<button disabled type="button" id="parentDataField" class="text-gray-900 bg-white border border-gray-300 focus:outline-none hover:bg-gray-100 focus:ring-0  font-medium rounded-full text-sm px-5 py-2.5 me-2 mb-2">Kudirat Ayeke</button> <i class="fas fa-arrow-right text-sm mx-2"></i>

<button disabled type="button" id="studentDataField" class="text-gray-900 bg-white border border-gray-300 focus:outline-none hover:bg-gray-100  focus:ring-0 font-medium rounded-full text-sm px-5 py-2.5 me-2 mb-2">Ismail Ayeke</button>
                            </div>
                        ...
                        <div class="w-full">
                            ...
                            <div class="relative ml-10 mr-7 w-full">
                                    ...
                                    <input list="parents" id="parentData" name="parent" class="block p-2 ps-10 text-sm text-gray-900 border border-gray-300 rounded-lg w-full bg-gray-50 focus:ring-0 focus:border-0" placeholder="Search for parents with their names, email or phone number">
                                </div>
                                <!-- <input name="parent" list="parents" placeholder="Parents"> -->
                                <datalist id="parents">
                                <?php foreach ($parents as $key => $parent): ?>
                                    <option value="<?=$parent['id']?>-<?=$parent['full_name']?>">
                                <?php endforeach; ?>
                                </datalist>
                            </div>
                                <div class="flex justify-between items-center gap-4 my-5">
                                <div class="relative ml-10 mr-7 w-full">
                                    ...
                                    <input id="studentData" name="student" list="students" class="block p-2 ps-10 text-sm text-gray-900 border border-gray-300 rounded-lg w-full bg-gray-50 focus:ring-0 focus:border-0" placeholder="Search for students with their names or admission number">
                                </div>
                            </div>
                                <!-- <input name="student" list="students" placeholder="Student"> -->
                                ...
                                <div class="text-center">
                                    <input type="submit" name="Assign Parent" class="mt-5 text-white bg-[#3b5998] hover:bg-[#3b5998]/90 focus:ring-4 focus:outline-none focus:ring-0 font-medium rounded-lg text-sm px-5 py-2.5 text-center inline-flex items-center me-2 mb-2" value="Assign Parent">
                            </div> 
                            </form>
                        </div>
                            ...
                            <!-- <div class="flex justify-between items-center gap-4 my-5">
                                <div class="relative ml-10 mr-7 w-full">
                                    ...
                                    <input type="text" id="table-search-users" class="block p-2 ps-10 text-sm text-gray-900 border border-gray-300 rounded-lg w-full bg-gray-50 focus:ring-0 focus:border-0" placeholder="Search for parents with their names, email or phone number">
                                </div>
                            </div>
                                ...
                                <table class="w-full text-sm text-left rtl:text-right">
                                    ...
                                    <tbody>
                                        <tr class="bg-white border-b  hover:bg-gray-50 cursor-pointer">
                                            <td class="w-4 p-4 mx-auto text-center">
                                                01
                                            </td>
                                            <th scope="row" class="flex items-center px-6 py-4 font-medium text-gray-900 whitespace-nowrap ">
                                                <img class="w-10 h-10 rounded-full" src="https://flowbite.com/docs/images/people/profile-picture-2.jpg" alt="Jese image">
                                        ...
                                        <tr class="bg-white border-b  hover:bg-gray-50 cursor-pointer">
                                        <td class="w-4 p-4 text-center mx-auto">
                                                02
                                            </td>
                                            <th scope="row" class="flex items-center px-6 py-4 font-medium text-gray-900 whitespace-nowrap ">
                                                <img class="w-10 h-10 rounded-full" src="https://flowbite.com/docs/images/people/profile-picture-5.jpg" alt="Jese image">
                                                <div class="ps-3">
                                                    <div class="text-base font-semibold">Thomas Lean</div>
                                                    <div class="font-normal text-gray-500">lean@scholarista.com</div>
                                        ...
                                        <tr class="bg-white  hover:bg-gray-50 cursor-pointer">
                                            ...
                                            <th scope="row" class="flex items-center px-6 py-4 font-medium text-gray-900 whitespace-nowrap ">
                                                <img class="w-10 h-10 rounded-full" src="https://flowbite.com/docs/images/people/profile-picture-4.jpg" alt="Jese image">
                                                <div class="ps-3">
                                                    <div class="text-base font-semibold">Amira Livingston</div>
                                                    <div class="font-normal text-gray-500">amira@scholarista.com</div>
                            ...
                            <div class="flex justify-between items-center gap-4 my-5">
                                <div class="relative ml-10 mr-7 w-full">
                                    ...
                                    <input type="text" id="table-search-users" class="block p-2 ps-10 text-sm text-gray-900 border border-gray-300 rounded-lg w-full bg-gray-50 focus:ring-0 focus:border-0" placeholder="Search for students with their names or admission number">
                                </div>
                            </div>
                            <div class="h-32 overflow-y-scroll">
                                <table class="w-full text-sm text-left rtl:text-right">
    ...
    <!-- Main modal -->
    <div id="authentication-modal" tabindex="-1" aria-hidden="true" class="hidden overflow-y-auto overflow-x-hidden fixed top-0 right-0 left-0 justify-center items-center w-full md:inset-0 h-[calc(100%-1rem)] max-h-full" style="z-index: 9999;">
        <div class="relative p-4 w-full max-w-2xl max-h-full">
            ...
            <div class="relative bg-white rounded-lg shadow w-full">
                ...
                <div class="p-4 md:p-5">
                    <form class="max-w-md mx-auto" action="<?= base_url('addstudent') ?>" method="post" id="studentForm">
                        <div class="grid gap-4 mb-4 grid-cols-2">
                            ...
                            <div class="col-span-1">
                                ...
                                <input type="date" name="dob" id="Date of Birth" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5" placeholder="2004-03-20" required="">
                            </div>
                            <div class="col-span-1">
                                <label for="class" class="block mb-2 text-sm font-medium text-gray-900">Class</label>
                                <select name="class" id="class" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-primary-500 focus:border-primary-500 block w-full p-2.5">
                            ...
                            <div class="col-span-2 sm:col-span-1">
                                <label for="class" class="block mb-2 text-sm font-medium text-gray-900">Gender</label>
                                <select name="gender" id="gender" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-primary-500 focus:border-primary-500 block w-full p-2.5">
                            ...
                            <div class="col-span-2 sm:col-span-1">
                                <label for="phone num" class="block mb-2 text-sm font-medium text-gray-900">Phone Number</label>
                                <input type="text" name="phone" id="phone" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-0 block w-full p-2.5" required="">
                            </div>
                        </div>
                        <button type="submit" class="text-white inline-flex items-center bg-blue-700 hover:bg-blue-800 focus:ring-0 focus:outline-none font-medium rounded-lg text-sm px-5 py-2.5 my-2 mt-4 text-center">
    ...
    <script>
        ...
        let parentData = document.querySelector('#parentData');
        let parentDataField = document.querySelector('#parentDataField');
        parentData.addEventListener('change',(e)=>{
                // console.log(parentData.value);
                let name = parentData.value;
                let nameData = name.split("-")[1].trim();
                // console.log(nameData);
                parentDataField.innerText = nameData;
            }
        )
        let studentData = document.querySelector('#studentData');
        let studentDataField = document.querySelector('#studentDataField');
        studentData.addEventListener('change',(e)=>{
                // console.log(studentData.value);
                let name = studentData.value;
                let nameData = name.split("-")[1].trim();
                // console.log(nameData);
                studentDataField.innerText = nameData;
            }
        )
